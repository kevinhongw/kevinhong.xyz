...
const projects = [
  {
    ...
    description: 'A Next.JS app that solve the Hong family\'s grocery shopping list problem.',
    image: 'images/thehappygrocers.png',
    technologies: ['Next.js', 'MongoDB'],
    link: 'https://thehappygrocers.com'
  },
  {
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div v-for="(project, index) in projects" :key="index"
          ...
          <div class="relative aspect-video">
            <NuxtImg :src="project.image" :alt="project.title" width="400" height="300"
